...
def test_search_tmdb_no_args(runner, mock_ctx, mock_llm_service_patch):
...
def test_search_tmdb_by_name_results(runner, mock_ctx, mock_llm_service_patch):
...
def test_search_tmdb_by_name_no_results(runner, mock_ctx, mock_llm_service_patch):
...
def test_search_tmdb_by_name_with_year(runner, mock_ctx, mock_llm_service_patch):
...
def test_search_tmdb_by_name_with_limit(runner, mock_ctx, mock_llm_service_patch):
...
def test_search_tmdb_by_tmdb_id_found(runner, mock_ctx, mock_llm_service_patch):
...
def test_search_tmdb_by_tmdb_id_not_found(runner, mock_ctx, mock_llm_service_patch):
...
def test_search_tmdb_dry_run(runner, mock_ctx, mock_llm_service_patch):
...
def test_search_tmdb_tmdb_error(runner, mock_ctx, mock_llm_service_patch):
